...
export default function Menu() {
  ...
  return (
    <div
      className={` ${isMenuOpen ? ' inline-block' : 'hidden'} absolute z-50 top-[60px] right-0 rounded-md outline outline-[2px] outline-LightGrey overflow-hidden shadow-lg bg-White`}
